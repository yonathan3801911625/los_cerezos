        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="block">
                    ...
                    <x-jet-input id="tipoMovimiento" class="block mt-1 w-full" type="text" name="tipoMovimiento" :value="old('tipoMovimiento', $movimiento->tipoMovimiento)" readonly />
                    ...
                    <x-jet-input id="valor" class="block mt-1 w-full" type="text" name="valor" :value="old('valor', $movimiento->valor)" readonly />
