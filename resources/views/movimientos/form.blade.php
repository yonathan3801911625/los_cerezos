...
<div class="block">
    ...
    <x-jet-input id="tipo_movimiento" class="block mt-1 w-full" type="date" name="tipo_movimiento" :value="old('tipo_movimiento', $movimiento->tipo_movimiento)" required autofocus />
    <x-jet-label for="cantidad" value="{{ __('Cantidad')}}" />
    <x-jet-input id="cantidad" class="block mt-1 w-full" type="date" name="cantidad" :value="old('cantidad', $movimiento->cantidad)" required autofocus />
    ...
    <x-jet-input id="fecha" class="block mt-1 w-full" type="double" name="fecha" :value="old('fecha', $movimiento->fecha)" required autofocus />
